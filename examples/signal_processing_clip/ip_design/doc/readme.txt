...
Input and output vectors has been mapped to a virtual memory at the followign adresses:
...
bmin			 	| 0x00000800
beta			 	| 0x00001000
lipschitz			 	| 0x00001800
x			 	| 0x00002000
w			 	| 0x00002800
num_iter			 	| 0x00003000
results			 	| 0x00003800

The virtual memory is used by foo_testbench.cpp during the C/RTL simulaiton.
