...
Xint32 *bmax_in_ptr_ddr = (Xint32 *) bmax_IN_DEFINED_MEM_ADDRESS;
Xint32 *bmin_in_ptr_ddr = (Xint32 *) bmin_IN_DEFINED_MEM_ADDRESS;
Xint32 *beta_in_ptr_ddr = (Xint32 *) beta_IN_DEFINED_MEM_ADDRESS;
Xint32 *lipschitz_in_ptr_ddr = (Xint32 *) lipschitz_IN_DEFINED_MEM_ADDRESS;
Xint32 *x_in_ptr_ddr = (Xint32 *) x_IN_DEFINED_MEM_ADDRESS;
Xint32 *w_in_ptr_ddr = (Xint32 *) w_IN_DEFINED_MEM_ADDRESS;
Xint32 *num_iter_in_ptr_ddr = (Xint32 *) num_iter_IN_DEFINED_MEM_ADDRESS;
Xint32 *results_out_ptr_ddr = (Xint32 *) results_OUT_DEFINED_MEM_ADDRESS;
			...
			if (packet_type==1) //reset IP
						{
					...
					else if (packet_type==2) //start IP
							{
								...
								XFoo_SetByte_bmax_in_offset(&xcore,bmax_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_bmin_in_offset(&xcore,bmin_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_beta_in_offset(&xcore,beta_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_lipschitz_in_offset(&xcore,lipschitz_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_x_in_offset(&xcore,x_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_w_in_offset(&xcore,w_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_num_iter_in_offset(&xcore,num_iter_IN_DEFINED_MEM_ADDRESS);
								XFoo_SetByte_results_out_offset(&xcore,results_OUT_DEFINED_MEM_ADDRESS);
					...
					else if (packet_type==3) //write data DDR
					{
						...
						switch (packet_internal_ID)
						{
							...
							case 0: //bmax_in
							if (DEBUG)
								printf("write bmax_in\n\r");
							memcpy(bmax_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
							
							case 1: //bmin_in
							if (DEBUG)
								printf("write bmin_in\n\r");
							memcpy(bmin_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
							
							case 2: //beta_in
							if (DEBUG)
								printf("write beta_in\n\r");
							memcpy(beta_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
							
							case 3: //lipschitz_in
							if (DEBUG)
								printf("write lipschitz_in\n\r");
							memcpy(lipschitz_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
							
							case 4: //x_in
							if (DEBUG)
								printf("write x_in\n\r");
							memcpy(x_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
							
							case 5: //w_in
							if (DEBUG)
								printf("write w_in\n\r");
							memcpy(w_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
							...
							for(k1=0;k1<ETH_PACKET_LENGTH;k1++)
								inputvec[k1] = inputvec[k1] >> FRACTIONLENGTH;
							memcpy(num_iter_in_ptr_ddr+(ETH_PACKET_LENGTH-2)*packet_internal_ID_offset,inputvec,sizeof(inputvec));
							break;
					...
					else if (packet_type==4) //read data from DDR
					{
						...
						switch (packet_internal_ID)
						{
							...
							case 0: //results_in
							if (DEBUG)
								printf("read results_out\n\r");
							memcpy(outvec,results_out_ptr_ddr+(ETH_PACKET_LENGTH_RECV-2)*packet_internal_ID_offset,(ETH_PACKET_LENGTH_RECV-2)*4);
							break;
