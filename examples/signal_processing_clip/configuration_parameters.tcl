...
set input_vectors [list "bmax" "bmin" "beta" "lipschitz" "x" "w" "num_iter"]
# Set the NAME of the OUTPUT vectors
set output_vectors [list "results"]
...
set max_vector_length 512

#Set FFT architecture: 1=radix-4, 2=radix-2, 3=pipelined, 4=radix-2 Lite
set fft_arch 1 


# ##############################
# Set the project name (a project folder with this name will be created)
set project_name "my_project1"
...
set bits_word_fraction_length 15;
