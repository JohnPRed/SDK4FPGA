...
puts $file ""
foreach i $input_vectors {
	append tmp_line "	data_t_large *" $i "_in_int;"
	puts $file $tmp_line
	unset tmp_line
	append tmp_line "	" $i "_in_int = (data_t_large *)malloc(N*sizeof (data_t_large));"
	puts $file $tmp_line
	unset tmp_line
}
foreach i $output_vectors {
	append tmp_line "	data_t_large *" $i "_out_int;"
	puts $file $tmp_line
	unset tmp_line
	append tmp_line "	" $i "_out_int = (data_t_large *)malloc(N*sizeof (data_t_large));"
	puts $file $tmp_line
	unset tmp_line
}
puts $file ""
...
puts $file ""
foreach i $input_vectors {
	append tmp_line "	data_t_large  " $i "_in_int\[N\];"
	puts $file $tmp_line
	unset tmp_line
}
foreach i $output_vectors {
	append tmp_line "	data_t_large  " $i "_out_int\[N\];"
	puts $file $tmp_line
	unset tmp_line
}
puts $file ""
...
puts $file "	{"
foreach i $input_vectors {
	append tmp_line "		" $i "_in_int\[i\]=(data_t_large)" $i "_in\[i\];"
	puts $file $tmp_line
	unset tmp_line
}
puts $file "	}"
...
foreach i $input_vectors {
	append tmp_line "	//" $i "_in_int\[N\] -> data type is data_t_large"
	puts $file $tmp_line
	unset tmp_line
}
puts $file "	//Output vectors are:"
foreach i $output_vectors {
	append tmp_line "	//" $i "_out_int\[N\] -> data type is data_t_large"
	puts $file $tmp_line
	unset tmp_line
}
