...
if {$board_name == "zedboard"} {
	...
	#connect CLIP external ports
	startgroup
	create_bd_port -dir O ovflo_din
	connect_bd_net [get_bd_pins /foo_0/ovflo_din] [get_bd_ports ovflo_din]
	endgroup
	startgroup
	create_bd_port -dir O ovflo_write
	connect_bd_net [get_bd_pins /foo_0/ovflo_write] [get_bd_ports ovflo_write]
	endgroup
	startgroup
	create_bd_port -dir I ovflo_full_n
	connect_bd_net [get_bd_pins /foo_0/ovflo_full_n] [get_bd_ports ovflo_full_n]
	endgroup
	
	#Add constraints CLIP external ports
	add_files -fileset constrs_1 -norecurse ../../../src/clip_baremetal.xdc
	import_files -fileset constrs_1 ../../../src/clip_baremetal.xdc
